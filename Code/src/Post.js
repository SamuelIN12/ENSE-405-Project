...
function Post({ postId, user, username, caption, topic, imageUrl, timestamp1}) {
  ...
  return (
    <div className="post">
      ...
      <div className="post__header">
        ...
        <h3>Posted by {username} on {timestamp1.toDate().toDateString()} </h3>
        {/* <h3>{timestamp1.toDate().toDateString()}</h3> */}
